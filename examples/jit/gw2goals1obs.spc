# 8-connected gridworld of size 3x8.  Dynamic obstacle in columns 0 through 3.
...
;
ENVGOAL: []<>((obs_x=2 | obs_x=3) & obs_y=1);
...
& []!(x'=0 & ((obs_y'=0 & y'=0) | (obs_y'=1 & y'=1) | (obs_y'=2 & y'=2)))
& []!(x'=1 & ((obs_y'=0 & y'=0) | (obs_y'=1 & y'=1) | (obs_y'=2 & y'=2)))
& []!(x'=2 & ((obs_y'=0 & y'=0) | (obs_y'=1 & y'=1) | (obs_y'=2 & y'=2)))
& []!(x'=3 & ((obs_y'=0 & y'=0) | (obs_y'=1 & y'=1) | (obs_y'=2 & y'=2)))
;
