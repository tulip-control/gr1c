# 4-connected gridworld of size 8x16.  Dynamic obstacle in columns 0 through 1.
...
& []((obs_x=0 & obs_x'=0) | (obs_x=1 & obs_x'=1) | (obs_y=0 & obs_y'=0) | (obs_y=1 & obs_y'=1) | (obs_y=2 & obs_y'=2) | (obs_y=3 & obs_y'=3) | (obs_y=4 & obs_y'=4) | (obs_y=5 & obs_y'=5) | (obs_y=6 & obs_y'=6) | (obs_y=7 & obs_y'=7))
;
...
& []!((obs_x'=0 & x'=0) & ((obs_y'=0 & y'=0) | (obs_y'=1 & y'=1) | (obs_y'=2 & y'=2) | (obs_y'=3 & y'=3) | (obs_y'=4 & y'=4) | (obs_y'=5 & y'=5) | (obs_y'=6 & y'=6) | (obs_y'=7 & y'=7)))
& []!((obs_x'=1 & x'=1) & ((obs_y'=0 & y'=0) | (obs_y'=1 & y'=1) | (obs_y'=2 & y'=2) | (obs_y'=3 & y'=3) | (obs_y'=4 & y'=4) | (obs_y'=5 & y'=5) | (obs_y'=6 & y'=6) | (obs_y'=7 & y'=7)))
